...
|---|---:|---|---|
| Core runtime coverage | **83 / 83 passing** | Fast regression gate for startup, package manager, syscall ABI, ARM64 fixtures, and language smoke rows. | `/workspace/tmp/ish-arm64-runtime-coverage-20260517-140328.md`; [runtime validation](RUNTIME_VALIDATION.md) |
...
| Node/Bun timing | **10 / 10 passing** | Startup/eval/JSON/FS timings for executor work. | Latest dormant-record fixture-hardening pair: default `/workspace/tmp/ish-arm64-node-bun-perf-20260517-140216.md`, stats+hot-trace `/workspace/tmp/ish-arm64-node-bun-perf-20260517-140252.md` |
| ARM64 hot-trace records | **6 / 6 passing** | Default-off silence, iOS/App default-off audit, and bounded sidecar record creation/retirement diagnostics without exact-output pollution. | `/workspace/tmp/ish-arm64-hot-trace-record-smoke-20260517-140126.md` |
